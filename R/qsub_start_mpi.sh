...
#$ -pe mpich 27 		 #  <- load the openmpi parallel env w/ 4 slots
...
mpirun -np 27 /data/uctprgu/R/x86_64-unknown-linux-gnu-library/3.0/snow/RMPISNOW -q < run.abbg.r > mpi_abbg.rout 
